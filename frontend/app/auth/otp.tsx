...
const styles = StyleSheet.create({
  ...
  otpRow: { flexDirection: "row", gap: spacing.sm, marginTop: spacing.xl, justifyContent: "space-between" },
  box: { flex: 1, height: 60, borderRadius: radii.md, borderWidth: 1.5, borderColor: colors.border, textAlign: "center", fontSize: 24, fontWeight: "700", color: colors.onSurface, backgroundColor: colors.surfaceSecondary },
